...
object3 = { 'id': 'object3', 'edge': 'edge2', 'pos': 5 }
object4 = { 'id': 'object4', 'edge': 'edge3', 'pos': 2 }
...
edge1 = { 'id': 'edge1', 'nodes': [node1, node2], 'weight': 10, 'objects': [object1, object2] }
edge2 = { 'id': 'edge2', 'nodes': [node2, node3], 'weight': 7, 'objects': [object3] }
edge3 = { 'id': 'edge3', 'nodes': [node3, node4], 'weight': 4, 'objects': [object4] }
